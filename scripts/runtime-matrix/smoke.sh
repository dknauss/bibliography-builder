...
WORKDIR="${RUNTIME_ROOT}/${SERVER}-php${PHP_VERSION}-wp${WP_VERSION}"
...
echo "Starting runtime smoke environment: server=${SERVER} php=${PHP_VERSION} wp=${WP_VERSION}"
...
echo "Runtime smoke passed: server=${SERVER} php=${PHP_VERSION} wp=${WP_VERSION}"
